...
#endif
{
    ...
    /* PCM Formats */
    _EXPORT_INT(m, "S8", SND_PCM_FORMAT_S8);
    _EXPORT_INT(m, "U8", SND_PCM_FORMAT_U8);
    _EXPORT_INT(m, "S16_LE", SND_PCM_FORMAT_S16_LE);
    _EXPORT_INT(m, "S16_BE", SND_PCM_FORMAT_S16_BE);
    _EXPORT_INT(m, "U16_LE", SND_PCM_FORMAT_U16_LE);
    _EXPORT_INT(m, "U16_BE", SND_PCM_FORMAT_U16_BE);
    _EXPORT_INT(m, "S24_LE", SND_PCM_FORMAT_S24_LE);
    _EXPORT_INT(m, "S24_BE", SND_PCM_FORMAT_S24_BE);
    _EXPORT_INT(m, "U24_LE", SND_PCM_FORMAT_U24_LE);
    _EXPORT_INT(m, "U24_BE", SND_PCM_FORMAT_U24_BE);
    _EXPORT_INT(m, "S32_LE", SND_PCM_FORMAT_S32_LE);
    _EXPORT_INT(m, "S32_BE", SND_PCM_FORMAT_S32_BE);
    _EXPORT_INT(m, "U32_LE", SND_PCM_FORMAT_U32_LE);
    _EXPORT_INT(m, "U32_BE", SND_PCM_FORMAT_U32_BE);
    _EXPORT_INT(m, "FLOAT_LE", SND_PCM_FORMAT_FLOAT_LE);
    _EXPORT_INT(m, "FLOAT_BE", SND_PCM_FORMAT_FLOAT_BE);
    _EXPORT_INT(m, "FLOAT64_LE", SND_PCM_FORMAT_FLOAT64_LE);
    _EXPORT_INT(m, "FLOAT64_BE", SND_PCM_FORMAT_FLOAT64_BE);
    _EXPORT_INT(m, "IEC958_SUBFRAME_LE", SND_PCM_FORMAT_IEC958_SUBFRAME_LE);
    _EXPORT_INT(m, "IEC958_SUBFRAME_BE", SND_PCM_FORMAT_IEC958_SUBFRAME_BE);
    _EXPORT_INT(m, "MU_LAW", SND_PCM_FORMAT_MU_LAW);
    _EXPORT_INT(m, "A_LAW", SND_PCM_FORMAT_A_LAW);
    _EXPORT_INT(m, "IMA_ADPCM", SND_PCM_FORMAT_IMA_ADPCM);
    _EXPORT_INT(m, "MPEG", SND_PCM_FORMAT_MPEG);
    _EXPORT_INT(m, "GSM", SND_PCM_FORMAT_GSM);
	_EXPORT_INT(m, "SPECIAL", SND_PCM_FORMAT_SPECIAL);
	_EXPORT_INT(m, "S24_3LE", SND_PCM_FORMAT_S24_3LE);
	_EXPORT_INT(m, "S24_3BE", SND_PCM_FORMAT_S24_3BE);
	_EXPORT_INT(m, "U24_3LE", SND_PCM_FORMAT_U24_3LE);
	_EXPORT_INT(m, "U24_3BE", SND_PCM_FORMAT_U24_3BE);
	_EXPORT_INT(m, "S20_3LE", SND_PCM_FORMAT_S20_3LE);
	_EXPORT_INT(m, "S20_3BE", SND_PCM_FORMAT_S20_3BE);
	_EXPORT_INT(m, "U20_3LE", SND_PCM_FORMAT_U20_3LE);
	_EXPORT_INT(m, "U20_3BE", SND_PCM_FORMAT_U20_3BE);
